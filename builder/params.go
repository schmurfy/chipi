...
func (b *Builder) generateParametersDoc(swagger *openapi3.T, op *openapi3.Operation, requestObjectType reflect.Type, method string, routeContext *chi.Context, fieldsFiltered []string) error {
